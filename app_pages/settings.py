...
CATEGORIES = {
    ...
    "fast": {
        ...
        "fields": [
            ...
            ("fast.max_depth", "Max Depth", "number", {"min_value": 0, "max_value": 10, "step": 1}),
            ("fast.max_pages", "Max Pages", "number", {"min_value": 1, "max_value": 100000, "step": 1}),
            ("fast.strip_query_params", "Strip Query Params", "bool", {}),
            ("fast.respect_robots_txt", "Respect robots.txt", "bool", {}),
            ("fast.include_patterns", "Include Patterns", "textarea", {}),
            ("fast.exclude_patterns", "Exclude Patterns", "textarea", {}),
            ("fast.allowed_domains", "Allowed Domains", "textarea", {}),
            ("fast.blocked_domains", "Blocked Domains", "textarea", {}),
            ("fast.auto_discover_sitemap", "Auto-discover Sitemap", "bool", {}),
        ],
    },
    "trafilatura": {
        "icon": "📄",
