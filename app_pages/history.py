...
def _render_run_detail_drawer(entry: dict, selected_rows: dict[str, list[int]], key_prefix: str, entry_idx: int = 0) -> None:
    ...
    # Use normalized collector keys from get_results() for display consistency
    collectors = list(by_collector.keys())
    labels = {"seo": "Quick SEO", "fast_seo": "Fast SEO", "extraction": "Custom Rules", "blog_audit": "Blog Audit"}
