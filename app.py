    ...
    with tab_ss:
        ...
        if submitted:
            ...
            if not urls:
                ...
                with SB(headless=True, window_size=f"{ss_width},{ss_height}") as sb:
    ...
    with tab_seo:
        ...
        if seo_submitted:
            ...
            if not urls_seo:
                ...
                with SB(headless=True, window_size=f"{runtime_cfg['viewport']['width']},{runtime_cfg['viewport']['height']}") as sb:
                    page = PageCapture(sb, runtime_cfg)
                    total = len(urls_seo)
