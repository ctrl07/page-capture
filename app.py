...
def page_extraction() -> None:
    ...
    if extract_mode == "Quick SEO":
        st.caption("Extract SEO data with configurable fields. Toggle which metrics to extract below.")
        seo_fields = render_seo_fields_selector(key_prefix="seo_fields")
        default_seo = ""
        ...
        if seo_submitted:
            ...
            if not urls_seo:
                ...
                runner = CaptureRunner(urls_seo, runtime_cfg, output_dir, "seo", seo_fields=seo_fields)
...
def page_seo_analysis() -> None:
    ...
    if results is None:
        ...
        seo_runs = [
            ...
            if h.get("kind") in ("seo", "unified") and (
